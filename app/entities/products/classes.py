...
class ProductBase(BaseModel):
    name: str = Field(..., min_length=2, max_length=35, description="Название продукта")
    ...
    user_id: Optional[int] = Field(None, description="ID пользователя,который добавил это,если нет - None")
